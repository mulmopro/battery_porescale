...
public static void main(String[] args) throws IOException
{
	...
	model = ParameterValues(model, currentDir, folder, paramFile, condFile, geomFile, seiFile, varFile);
	...
	// Physics //
	model = PhysicsDefinition(model, z, cathode, sei);
	...
	// Case study //
	model = TestStudy(model, time, tol, sei);
	System.out.println("TestStudy created");
}

public static Model ParameterValues(Model model, String currentDir, String folder, String paramFile, String condFile, String geomFile, String seiFile, String varFile) {
	...
	model.param("par4").label("SEI");
	String filePath13 = currentDir + folder + seiFile;
	model.param("par4").loadFile(filePath13);

	// COMSOL Variables //
	model.component("TestCase").variable().create("var1");
	String filePath14 = currentDir + folder + varFile;
	model.component("TestCase").variable("var1").loadFile(filePath14);
...
public static Model PhysicsDefinition(Model model, Zone z, boolean cathode, boolean sei) {
	...
	if (sei)
	{
		model.component("TestCase").physics("liion").feature("bei1").setIndex("Species", "SEI", 0, 0);
		model.component("TestCase").physics("liion").feature("bei1").setIndex("rhos", "rho_SEI", 0, 0);
    	model.component("TestCase").physics("liion").feature("bei1").setIndex("Ms", "M_SEI", 0, 0);
    	model.component("TestCase").physics("liion").feature("bei1").set("FilmResistanceType", "ThicknessAndConductivity");
    	model.component("TestCase").physics("liion").feature("bei1").set("sf0", "L0");
    	model.component("TestCase").physics("liion").feature("bei1").set("dsf_src", "root.TestCase.liion.sbtot");
    	model.component("TestCase").physics("liion").feature("bei1").set("sigmaf", "sigma_SEI");
		model.component("TestCase").physics("liion").feature("bei1").create("er2", "ElectrodeReaction", 2);
    	model.component("TestCase").physics("liion").feature("bei1").feature("er2").set("Eeq_mat", "userdef");
    	model.component("TestCase").physics("liion").feature("bei1").feature("er2").set("Eeq", "U_SEI");
    	model.component("TestCase").physics("liion").feature("bei1").feature("er2").set("ilocmat_mat", "userdef");
		model.component("TestCase").physics("liion").feature("bei1").feature("er2").set("ilocmat", "j_SEI");
		model.component("TestCase").physics("liion").feature("bei1").feature("er2").set("VLiPlus", "-nu_Li");
		model.component("TestCase").physics("liion").feature("bei1").feature("er2").set("nm", "nu_Li");
		model.component("TestCase").physics("liion").feature("bei1").feature("er2").setIndex("Vib", "nu_SEI", 0, 0);
    	model.component("TestCase").physics("liion").feature("bei1").feature("er2").set("dEeqdT_mat", "userdef");
		model.component("TestCase").physics("liion").feature("bei1").feature("er2").set("dEeqdT", 0);
		model.component("TestCase").physics("liion").feature("bei1").label("Electrode/Electrolyte Interface");
		// Charge Discharge Cycling //
		model.component("TestCase").physics("liion").create("cdc1", "ChargeDischargeCycling", 2);
    	model.component("TestCase").physics("liion").feature("cdc1").set("Idch", "-I_DCH");
    	model.component("TestCase").physics("liion").feature("cdc1").set("Vmin", "E_min");
    	model.component("TestCase").physics("liion").feature("cdc1").set("Ich", "I_CH");
    	model.component("TestCase").physics("liion").feature("cdc1").set("Vmax", "E_max");
    	model.component("TestCase").physics("liion").feature("cdc1").set("item.OCDCH", true);
    	model.component("TestCase").physics("liion").feature("cdc1").set("tredch", "rest_DCH");
    	model.component("TestCase").physics("liion").feature("cdc1").set("item.OCCH", true);
    	model.component("TestCase").physics("liion").feature("cdc1").set("trech", "rest_CH");
    	model.component("TestCase").physics("liion").feature("cdc1").set("phis0init", "mat1.elpot.Eeq_int1(cs0/csmax)");
		model.component("TestCase").physics("liion").feature("cdc1").selection().named("geom1_"+z.select("Electrode Current Collector"));
	} 
	else
	{
		...
		model.component("TestCase").physics("liion").feature("ec1").set("Its", "-I_DCH");
...
public static Model TestStudy(Model  model, String time, Tolerance tol, boolean sei) {
	...
	model.component("TestCase").probe().create("var2", "GlobalVariable");
	if (sei){
		model.component("TestCase").probe("var2").label("Global Variable Probe - E cell");
		model.component("TestCase").probe("var2").set("expr", "liion.cdc1.phis0");
		model.component("TestCase").probe("var2").set("descractive", true);
		model.component("TestCase").probe("var2").set("descr", "Cell voltage");
	}
	else{
		model.component("TestCase").probe("var2").label("Global Variable Probe - E cell");
		model.component("TestCase").probe("var2").set("expr", "liion.phis0_ec1");
		model.component("TestCase").probe("var2").set("descractive", true);
		model.component("TestCase").probe("var2").set("descr", "Cell voltage");
	}
